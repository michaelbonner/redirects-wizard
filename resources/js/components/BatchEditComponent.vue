<template>
  <div class="bg-white mx-auto shadow-md rounded overflow-hidden mb-4">
    <div class="p-4 border-gray-300 border-b mb-6" v-if="dev_url">
      ...
      >
        <i class="fas fa-sync-alt" :class="{ spin: submittingRecheckAll }"></i>
        Recheck All
      </button>
      <a
        :href="rewriteUrl"
        ...
        <div class="mb-8" v-if="!validUrl">
          ...
          >
            <div class="flex">
              ...
              <div>
                <p class="font-bold">
                  You must enter a valid dev url before you can start
                </p>
                <p class="text-sm">
                  The dev URL is where we are actively developing the site.
                </p>
    ...
    <add-urls-component :batch_id="batch_id" v-if="validUrl && submittedDevUrl">
      Add Url
    </add-urls-component>
